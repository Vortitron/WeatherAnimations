/*
 * TFT Display Usage Example for WeatherAnimations Library - DEVELOPMENT VERSION
 * 
 * This is a development version of the example that directly includes the library source files.
 * Use this during library development to avoid repeatedly installing or zipping the library.
 * 
 * Setup:
